...
storage.mount('i18n', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/svenlochner/Documents/Projects Sonstige/Piano/piano-notes/.nuxt/i18n","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _QQklUs = defineEventHandler(async (event) => {
...
const _k1Zo1t = defineEventHandler(async (event) => {
...
const _lazy_JbGJ7T = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_JbGJ7T, lazy: true, middleware: false, method: undefined },
  { route: '/__i18n__/precompile', handler: _QQklUs, lazy: false, middleware: false, method: "post" },
  { route: '/__i18n__/prerender/:hash', handler: _k1Zo1t, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_JbGJ7T, lazy: true, middleware: false, method: undefined }
];
