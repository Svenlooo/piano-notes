import { getCurrentInstance, version, toRef, isRef, defineAsyncComponent, defineComponent, h, inject, onUnmounted, hasInjectionContext, ref, watchEffect, watch, computed, Fragment, createApp, reactive, effectScope, isReactive, toRaw, unref, useSSRContext, getCurrentScope, onScopeDispose, nextTick, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRefs, markRaw, shallowRef, isReadonly, Text, isShallow, mergeProps, withCtx, Suspense, Transition } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no" }, { "charset": "utf-8" }, { "name": "application-name", "content": "Piano Notes" }, { "name": "theme-color", "content": "#FBF7F5" }, { "name": "mobile-web-app-capable", "content": "yes" }, { "name": "apple-mobile-web-app-capable", "content": "yes" }, { "name": "apple-mobile-web-app-title", "content": "Piano Notes" }, { "name": "msapplication-tooltip", "content": "Learn Piano Notes" }, { "name": "msapplication-starturl", "content": "/" }, { "name": "msapplication-tap-highlight", "content": "no" }, { "name": "full-screen", "content": "yes" }, { "name": "browser-mode", "content": "application" }], "link": [{ "rel": "icon", "href": "/favicon.ico" }, { "rel": "apple-touch-icon", "href": "/images/pwa-icons/apple-touch-icon.png", "sizes": "180x180" }, { "rel": "mask-icon", "href": "/images/pwa-icons/apple-touch-icon.png", "sizes": "180x180" }], "style": [], "script": [], "noscript": [], "charset": "utf-8", "viewport": "width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no" };
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-91f4fc29.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-0149edc0.mjs').then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/highscore-5c51d79b.mjs').then((m) => m.default || m)
  },
  {
    name: "highscore___de",
    path: "/de/highscore",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-b0de2290.mjs').then((m) => m.default || m)
  },
  {
    name: "index___de",
    path: "/de",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/settings-b9ea038c.mjs').then((m) => m.default || m)
  },
  {
    name: "settings___de",
    path: "/de/settings",
...
const additionalMessages = Object({ "en": [], "de": [] });
const resolveNuxtI18nOptions = async (context) => {
  ...
  nuxtI18nOptions.locales = [Object({ "code": "en", "iso": "en-US", "name": "English" }), Object({ "code": "de", "iso": "de-DE", "name": "Deutsch" })];
  ...
  nuxtI18nOptions.detectBrowserLanguage = Object({ "alwaysRedirect": false, "cookieCrossOrigin": false, "cookieDomain": null, "cookieKey": "i18n_redirected", "cookieSecure": false, "fallbackLocale": "", "redirectOn": "root", "useCookie": false });
  ...
  nuxtI18nOptions.missingWarn = false;
  nuxtI18nOptions.messages = Object({ "en": Object({ "title": "Piano Notes", "subline": "by Sven Lochner" }), "de": Object({ "title": "Noten lernen", "subline": "von Sven Lochner" }) });
...
const nuxtI18nInternalOptions = Object({ __normalizedLocales: [Object({ "code": "en", "iso": "en-US", "name": "English" }), Object({ "code": "de", "iso": "de-DE", "name": "Deutsch" })] });
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "title" }, _attrs))}><h1 class="title__heading">${ssrInterpolate(props.title)}</h1>`);
      if (props.subline) {
        _push(`<span class="title__subline">${ssrInterpolate(props.subline)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/desktop/Title.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DesktopTitle = __nuxt_component_2;
      const _component_NuxtPage = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "app-wrapper" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_VitePwaManifest, null, null, _parent));
      _push(ssrRenderComponent(_component_NuxtLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_DesktopTitle, {
              class: "title",
              title: _ctx.$t("title"),
              subline: _ctx.$t("subline")
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_NuxtPage, { class: "page-wrapper" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_DesktopTitle, {
                class: "title",
                title: _ctx.$t("title"),
                subline: _ctx.$t("subline")
              }, null, 8, ["title", "subline"]),
              createVNode(_component_NuxtPage, { class: "page-wrapper" })
            ];
          }
        }),
        _: 1
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-736d36de.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-5c2b9504.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useSettingsStore as a, useI18n as b, createError as c, defineStore as d, entry$1 as default, useNuxtApp as e, useState as f, useHead as g, useRouter as h, navigateTo as n, useServerSeoMeta as u };
