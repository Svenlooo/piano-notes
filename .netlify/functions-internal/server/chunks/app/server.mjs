import { getCurrentInstance, version, toRef, isRef, defineAsyncComponent, hasInjectionContext, inject, ref, watchEffect, watch, createApp, reactive, effectScope, isReactive, toRaw, unref, useSSRContext, getCurrentScope, onScopeDispose, nextTick, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRefs, markRaw, computed, shallowRef, isReadonly, isShallow, mergeProps, withCtx, defineComponent, h, Suspense, Transition } from 'vue';
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-b0cc4d63.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-e0dd231e.mjs').then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/highscore-863c35aa.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-f030fda9.mjs').then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/settings-b19f6f58.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-854adc9b.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-d65399bf.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useSettingsStore as a, useNuxtApp as b, createError as c, defineStore as d, entry$1 as default, useState as e, useHead as f, useRouter as g, navigateTo as n, useServerSeoMeta as u };
